...
export class CPU {
    ...
    */
    get keypad() {
        ...
        _assertNum(this.ptr);
        const ret = wasm.__wbg_get_cpu_keypad(this.ptr);
        return Keypad.__wrap(ret);
    }
    /**
    * @param {Keypad} arg0
    */
    set keypad(arg0) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        _assertClass(arg0, Keypad);
        if (arg0.ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        var ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_cpu_keypad(this.ptr, ptr0);
    }
    /**
    */
    constructor() {
    ...
    */
    dump_opcode() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cpu_dump_opcode(this.ptr);
        return ret;
    }
    /**
    * @returns {Uint8Array}
    */
    dump_memory() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cpu_dump_memory(this.ptr);
    ...
    */
    get_frame_buffers() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cpu_get_frame_buffers(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    load_rom(rom) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.cpu_load_rom(this.ptr, ptr0, len0);
    }
    /**
    */
    run_cycle() {
    ...
    */
    key_down(key) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.cpu_key_down(this.ptr, key.codePointAt(0));
    }
    /**
    * @param {string} key
    */
    key_up(key) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.cpu_key_up(this.ptr, key.codePointAt(0));
    }
}
/**
*/
export class Keypad {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Keypad.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_keypad_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.keypad_new();
        return Keypad.__wrap(ret);
    }
    /**
    * @param {string} key
    */
    key_down(key) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.keypad_key_down(this.ptr, key.codePointAt(0));
    }
    /**
    * @param {string} key
    */
    key_up(key) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.keypad_key_up(this.ptr, key.codePointAt(0));
    }
    /**
    * @param {number} key
    * @returns {number}
    */
    key_state(key) {
        ...
        _assertNum(this.ptr);
        _assertNum(key);
        const ret = wasm.keypad_key_state(this.ptr, key);
        return ret;
    }
    /**
    ...
    */
    get_down_key() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.keypad_get_down_key(this.ptr);
...
function getImports() {
    ...
    imports.wbg.__wbg_alert_4fd8321f1786e17c = function() { return logError(function (arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('chip_8_emulator_rust_bg.wasm', import.meta.url);
    }
    const imports = getImports();
